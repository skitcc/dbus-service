...
В случае ошибки в написании конфигурационных файлов или в любых других случаях в проекте используется система исключений, которая будет оповещать вас о ваших ошибках
вот например создим файл конфигурации и в нем будет содержаться следующее
...
TimeoutPhrase string:papa
```
(опечатка в слове timeout и обьект с именем "timout" нигде не зарегестрирован и не определен)
Будет выведена следующая ошибка

![alt text](./images/image-1.png)

или например вы описались в аттрибуте обьекта (период времени)
```
--META--
Timeout
--------
...
TimeoutPhrase string:papa
```
(опечатка в аттрибуте timeout)
в таком случае вам тоже выведется ошибка (перед запуском стоит проверить класс конфигурации ./common/Config.h)
